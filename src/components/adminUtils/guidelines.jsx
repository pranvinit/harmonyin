...
export function Guidelines(props) {
    const handleClick = () => {
        props.handleGuidlines();
    }
    return (
        <div id="outerdiv" key={props.index}>
            <div id="guidelines-inner-container">
                <div id="remove-feedback-alert" onClick={handleClick}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-x-lg" viewBox="0 0 16 16">
                        <path d="M1.293 1.293a1 1 0 0 1 1.414 0L8 6.586l5.293-5.293a1 1 0 1 1 1.414 1.414L9.414 8l5.293 5.293a1 1 0 0 1-1.414 1.414L8 9.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L6.586 8 1.293 2.707a1 1 0 0 1 0-1.414z" />
                    </svg>
                </div>
                <span id="guidelines-heading">Welcome to Harmony Studio</span>
                <div id="svg-container">
                    <svg xmlns="http://www.w3.org/2000/svg" id="ff813a3e-4c7b-4d7b-b4d4-03a41dc284cb" data-name="Layer 1"
                        width="263.4058892" height="200" viewBox="0 0 843.57946 640.51678" className="injected-svg gridItem__media">
                        <path
                            ...
                            transform="translate(-178.21027 -129.74161)" fill="#f2f2f2"></path>
                        <path
                            ...
                            transform="translate(-178.21027 -129.74161)" fill="#fff"></path>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-178.21027 -129.74161)" fill="#e6e6e6"></path>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-178.21027 -129.74161)" fill="#f50057"></path>
                        <path d="M1020.78973,770.09988h-219a1,1,0,0,1,0-2h219a1,1,0,0,1,0,2Z"
                            transform="translate(-178.21027 -129.74161)" fill="#3f3d56"></path>
                        <path
                            ...
                            transform="translate(-178.21027 -129.74161)" fill="#ffb8b8"></path>
                        <path
                            ...
                            transform="translate(-178.21027 -129.74161)" fill="#f50057"></path>
                        <polygon points="728.243 629.901 716.811 629.9 711.374 585.804 728.247 585.805 728.243 629.901"
                            fill="#ffb8b8"></polygon>
                        <path
                            ...
                            fill="#2f2e41"></path>
                        <polygon points="789.864 629.901 778.432 629.9 772.995 585.804 789.868 585.805 789.864 629.901"
                            fill="#ffb8b8"></polygon>
                        <path
                            ...
                            fill="#2f2e41"></path>
                        <circle cx="756.38308" cy="291.8647" r="24.56103" fill="#ffb8b8"></circle>
                        <path
                        ...
                        <path
                            ...
                            transform="translate(-178.21027 -129.74161)" fill="#2f2e41"></path>
                        <path
                ...
                <ul id="guidelines-list">
                    <li className="guildelines-li"><span>Be respectful and polite</span></li>
                    <li className="guildelines-li"><span>Edit count must not exceed 3</span></li>
                    <li className="guildelines-li"><span>Image files should be properly optimised</span></li>
                    <li className="guildelines-li"><span>Add a relavant and meaningful title</span></li>
                    <li className="guildelines-li"><span>Add relavent content</span></li>
                </ul>
            </div>
        </div>
    )
